									...
									<div class="row ipad-width2">
										...
										<div class="col-md-8 col-sm-12 col-xs-12">
											<div class="movie-single-ct main-content">
												...
												<h1 class="bd-hd">{{ $tv->title }}<span>  {{ $tv->year }}</span></h1>
													...
													<div class="tabs">
															...
															<div id="overview" class="tab active">
																<div class="row">
																	<div class="col-md-8 col-sm-12 col-xs-12">
																		...
																		<br>
																		<iframe width="560" height="315" src="{{ $tv->video }}" frameborder="0" allowfullscreen></iframe>
																		<br>
														...
														<div class="col-md-9 col-sm-12 col-xs-12">
															<div class="form-style-1 user-pro" action="#">
																...
																@csrf
																	<input class="form-input" type="hidden" name="title" value="{{ $tv->title }}">
																
																	<h4>Review Form</h4>
																	<div class="row">
																	<input class="form-input" type="hidden" name="poster" value="{{ $tv->image }}">
																	<input class="form-input" type="hidden" name="movie" value="{{ $tv->title }}">
