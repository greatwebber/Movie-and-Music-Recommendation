													...
													<div class="tabs">
														...
														<div class="col-md-9 col-sm-12 col-xs-12">
															<div class="form-style-1 user-pro" action="#">
																...
																@csrf
																	<input class="form-input" type="hidden" name="title" value="{{ $movie->title }}">
																
																	<h4>Review Form</h4>
																	<div class="row">
																	<input class="form-input" type="hidden" name="poster" value="{{ $movie->image }}">
