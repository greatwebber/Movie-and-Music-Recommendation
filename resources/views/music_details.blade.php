														...
														<div id="overview" class="tab active">
															<div class="row">
																<div class="col-md-8 col-sm-12 col-xs-12">
																	...
																	<br>
																		<iframe width="540" height="315" src="{{ $music->video }}" frameborder="0" allowfullscreen></iframe>
																	<br>
																	<div class="title-hd-sm">
																		<h4>Lyrics</h4>											
																	</div>
																	<div class="mv-user-review-item" style="height:400px;width:1000px;font:16px/26px Georgia, Garamond, Serif;overflow:auto;">												
																			<p class="time">
																			<a>
																			<?php
																			echo str_replace("<br>","<br>","$music->lyrics");
																			?>
																			</a>
																			</p>
																...
																<div class="col-md-4 col-xs-12 col-sm-12">
																	...
																	<div class="sb-it">
																		<h6>Date Released</h6>
																		<p class="tags">
																			<span class="time"><a href="#">{{ $music->year }}</a></span>
														...
														<div class="col-md-9 col-sm-12 col-xs-12">
															<div class="form-style-1 user-pro" action="#">
																...
																@csrf
																	...
																	<h4>Review Form</h4>
																	<div class="row">
																	<input class="form-input" type="hidden" name="poster" value="{{ $music->image }}">
																	<input class="form-input" type="hidden" name="title" value="{{ $music->title }}">
